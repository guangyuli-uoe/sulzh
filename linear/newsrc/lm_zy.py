...
class LinearModel(object):
    ...
    def score(self, fvector, average=False):
        # print(f'this is score: {fvector}')
        '''
        this is score: [('02', 22, (1232,)), ('03', 22, (1873,)), ('04', 22, (340,)), ('05', 22, (1232,), 1873), ('06', 22, (1232,), 340), ('07', 22, 1232), ('08', 22, 1232), ('12', 22, (1232,), 1873, 340), ('14', 22, (1232,)), ('15', 22, (1232,))]
