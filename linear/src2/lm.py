...
class linear_model:
    ...
    def online_training(self):
        ...
        print("Conclusion:")
        print("\t" + self.train.name + " iterator: " + str(max_train_iterator) + "\t" + str(max_train_c) + " / " + str(
            max_train_count) + " = " + str(max_train_precision))
        print("\t" + self.dev.name + " iterator: " + str(max_dev_iterator) + "\t" + str(max_dev_c) + " / " + str(
            max_dev_count) + " = " + str(max_dev_precision))
    ...
    def save_model(self, iterator):
        ...
        for key in self.model:
            ...
            fmodel.write(key + "\t" + str(self.model[key]) + '\n')
        fmodel.close()
