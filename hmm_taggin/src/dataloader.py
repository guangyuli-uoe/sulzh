...
#     # v,n =loader1(train_path)
#     # print(f'v: {v}')
#     # print(f'n: {n}')
#
#     print('-------------- test class ----------------')
#
#     loader111 = Loader(train_path)
#     print(loader111.V)
#     print(loader111.N)
#     print(loader111.vocab_fre_dict)
#     print(f'tag_list: {loader111.tag_list}')
#     # print(f'nn 2 id: {loader111.tag2id("NN")}')
#     print('===')
#     print(loader111.tag_list)
#
#     print(loader111.tag_fre_dict)
#     print(loader111.vocab_list)
#
#     print('--------------sent level----------------')
#     print(loader111.sent_list)
#     print(loader111.sent_tag_list)
#     print(len(loader111.sent_list))
#     print(len(loader111.sent_tag_list))
#     print(loader111.sent_list[11])
#     print(loader111.sent_tag_list[11])
#     print(len(loader111.sent_list[11]))
#     print(len(loader111.sent_tag_list[11]))
